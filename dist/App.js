...
const Input = forwardRef((props, ref) => {
    return (<View style={{ borderWidth: 1, borderColor: 'rgb(247, 248, 250)', borderRadius: 20, backgroundColor: 'white', marginVertical: 8 }}>
...
function Button(props) {
    return (<View style={{ borderWidth: 1, borderColor: 'rgb(247, 248, 250)', borderRadius: 16, backgroundColor: 'rgb(230, 0, 110)', marginVertical: 8 }}>
...
export default function App(props) {
    ...
    const { inputAmount, inputAmountDisplay, inputAsExactAmount, isMax, isSufficientBalance, nativeAmount, outputAmount, outputAmountDisplay, setIsSufficientBalance, updateInputAmount, updateNativeAmount, updateOutputAmount, } = useSwapInputs({
    ...
    */
    ...
    const { allPairs } = useUniswapPairs(inputCurrency, outputCurrency, wallet.provider, wallet.chainId);
    ...
    const calculateOutputGivenInputChange = useCallback(({ isInputEmpty, isInputZero }) => {
        ...
        if ((isInputEmpty || isInputZero) &&
            ...
            if (!isZero(rawUpdatedOutputAmount)) {
                const outputPriceValue = tradeDetails === null || tradeDetails === void 0 ? void 0 : tradeDetails.outputPriceValue;
    ...
    return (<View style={{ flex: 1, paddingVertical: 40 }}>
      <View style={{
        flex: 1,
        padding: 20,
