 ...
 * @return {String}
 */
export const toFixedDecimals = (value, decimals) => BigNumber(`${value}`).toFixed(decimals);
/**
 ...
 * @return {Boolean}
 */
export const greaterThan = (numberOne, numberTwo) => BigNumber(`${numberOne}`).gt(numberTwo);
/**
 ...
 * @return {Boolean}
 */
export const greaterThanOrEqualTo = (numberOne, numberTwo) => BigNumber(`${numberOne}`).gte(numberTwo);
/**
 ...
 * @return {String}
 */
export const isEqual = (numberOne, numberTwo) => BigNumber(`${numberOne}`).eq(numberTwo);
/**
 ...
 */
export const feeCalculation = (amount, percentFee, fixedFee) => BigNumber(amount)
    .times(percentFee)
    .dividedBy(100)
    .plus(fixedFee)
 ...
 */
export const updatePrecisionToDisplay = (amount, nativePrice, roundUp = false) => {
    if (!amount)
        return 0;
    if (!nativePrice)
        return amount;
 ...
 * @return {String}
 */
export const convertAmountFromNativeValue = (value, priceUnit, decimals = 18) => BigNumber(BigNumber(value)
    .dividedBy(BigNumber(priceUnit))
    .toFixed(decimals, BigNumber.ROUND_DOWN)).toFixed();
/**
 ...
 * @return {String}
 */
export const lessThan = (numberOne, numberTwo) => BigNumber(`${numberOne}`).lt(numberTwo);
/**
 ...
 * @return {BigNumber}
 */
export const convertAmountToNativeAmount = (amount, priceUnit) => multiply(amount, priceUnit);
/**
 ...
 * @return {String}
 */
export const convertAmountAndPriceToNativeDisplay = (amount, priceUnit, nativeCurrency, buffer) => {
 ...
 * @return {String}
 */
export const convertRawAmountToNativeDisplay = (rawAmount, assetDecimals, priceUnit, nativeCurrency, buffer) => {
 ...
 * @return {String}
 */
export const convertAmountToPercentageDisplay = (value, decimals = 2, buffer) => {
    const display = handleSignificantDecimals(value, decimals, buffer);
    return `${display}%`;
};
/**
 ...
 * @return {String}
 */
export const convertBipsToPercentage = (value, decimals = 2) => BigNumber(`${value}`)
    .shiftedBy(-2)
    .toFixed(decimals);
/**
